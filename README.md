## GIT & GITHUB란?
**팀프로젝트**에서 중요 : 버전관리 SW & 클라우드 저장소
=> 버전관리1등 : git + 클라우드 1등 : github  

GIT : 버전 관리, 아카이빙, 협업관리 등을 제공하는 소프트웨어 프로그램  
GITHUB : 로컬 작업을 ㄹ웹에 호스팅함으로써 공유, 협업이 가능하도록하는 원격 '저장소'

=> git -> 커피 / github -> 커피샵 
   ㄴ git : 내 컴퓨터에 있는 모든 파일의 변화를 기록 -> github라는 공간에 올려줌
<br> 
...
#### 5. cherry-pick **
: 여러가지 커밋들중 원하는 것만 떼서 지금 브랜치에 붙이는 것 
